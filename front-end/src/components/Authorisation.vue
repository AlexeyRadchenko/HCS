...
<div class="wrapper">
  <div class="container" v-loading="loading">
    <h1>Управляющая компания "Комфортный дом"</h1>
...
<script>
import { login } from '../http/http-common';
...
export default {
  ...
  methods: {
    onSubmit () {
	  ...
	  login(this.authStore, userFormData, loading, this.$router)
	  }
  },
  computed: {
	  showError () {
		  if (this.authStore.getError)
		    return true
		  return false
	  }
  }
...
<style lang="less">
/*@import url("src/assets/login/fonts");*/
...
body{
	font-family: 'Source Sans Pro', sans-serif;
  	src: url("src/assets/login/fonts/SourceSansPro-Regular.ttf");
	color: white;
	font-weight: 300;

...
class AccountPaymentResourcesData(Base):
    ...
    id = Column(BigInteger, primary_key=True, index=True, nullable=False, autoincrement=True)
    doc_date = Column(DateTime, nullable=False)
    oid_gvs = Column(DECIMAL(12,6), nullable=True)
    oid_stoch_vod = Column(DECIMAL(12,6), nullable=True)
    oid_tpl_en_na_gvs = Column(DECIMAL(12,6), nullable=True)
    oid_h_v_tepl_na_gvs = Column(DECIMAL(12,6), nullable=True)
    oid_hvs = Column(DECIMAL(12,6), nullable=True)
    oid_el_en = Column(DECIMAL(12,6), nullable=True)
